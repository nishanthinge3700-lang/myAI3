...
export const OWNER_NAME = "Rahil Gosalia";

export const WELCOME_MESSAGE = `Yo Bro, What's up! I'm ${AI_NAME}, an AI assistant created by ${OWNER_NAME}. How can I be of assistant`
